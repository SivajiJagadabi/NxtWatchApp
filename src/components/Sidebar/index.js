          ...
          >
            <NavItems>
              <NavLink to="/" style={{textDescoration: 'none'}}>
                <NavItem
                  onClick={onClickHome}
                  bgColors={activeTab === 'Home' ? activeTabBg : 'none'}
                  iColor={activeTab === 'Home' ? iconColor : 'gray'}
                >
              ...
              <NavLink to="/trending">
                <NavItem
                  ...
                  bgColors={activeTab === 'Trending' ? activeTabBg : 'none'}
                  iColor={activeTab === 'Trending' ? iconColor : 'gray'}
                >
              ...
              <NavLink to="/gaming">
                <NavItem
                  onClick={onClickGame}
                  bgColors={activeTab === 'Gaming' ? activeTabBg : 'none'}
                  iColor={activeTab === 'Gaming' ? iconColor : 'gray'}
                >
              ...
              <NavLink to="/saved-videos">
                <NavItem
                  ...
                  bgColors={activeTab === 'Saved Videos' ? activeTabBg : 'none'}
                  iColor={activeTab === 'Saved Videos' ? iconColor : 'gray'}
                >
                  <CgPlayListAdd style={{fontSize: 20}} />
                  <NavText style={{color: `${textColor}`}}>
                    Saved Videos
                  </NavText>
                </NavItem>
              </NavLink>
